...
<body>
	...
	<h1 class="text" style="color: black; text-align: center; margin-top: 80px;">Cadastrar  Pagamentos Recorrentes</h1>
    <main role="main" class="container mt-5 pt-5">
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-header">Registrar Pagamento Recorrente</div>
                    <div class="card-body">
