...
public class CartaoDebitoServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		dao = DAOFactory.getCartaoDebitoDAO();
	}
    ...
    private void excluir(HttpServletRequest request, HttpServletResponse response)
    	...
    	try {
    		dao.remover(codigo);
    		request.setAttribute("msg", "Cartão de débito removido!");
    	} catch (DBException e) {
    		e.printStackTrace();
    ...
    private void editar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
			...
			CartaoDebito cartaoDebito = new CartaoDebito(numero, "ativo", virtual, conta.getSaldo(), conta);			
			dao.atualizar(cartaoDebito);
			
    		request.setAttribute("msg", "Cartão de débito atualizado!");
    ...
    private void cadastrar(HttpServletRequest request, HttpServletResponse response)
    	...
    	try {
			...
			dao.cadastrar(cartaoDebito);
			
			request.setAttribute("msg", "Cartão de débito cadastrado!");
    	} catch (DBException db) {
    		db.printStackTrace();
